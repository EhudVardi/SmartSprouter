...
public:
    ...
    DisplayTimeSpan updateProcess(const DisplayDateTime& now, float currHumidity, float currTemperatur); // interval process update. update process events, update remaining time, and returns remaining time
