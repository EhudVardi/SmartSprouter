...
void HR_E_MIN::handleInput(SystemContext* context, InputEvent event) {
    if (setupPage) {
        switch (event) {
            case InputEvent::EnterPressed: stateMachine->changeState(SetupStates::HUMIDITY_RANGE_EDIT_MAX, context); break;
...
void HR_E_MAX::handleInput(SystemContext* context, InputEvent event) {
    if (setupPage) {
        switch (event) {
            case InputEvent::EnterPressed: stateMachine->changeState(SetupStates::HUMIDITY_RANGE_SELECT, context); break;
...
void TR_E_MIN::handleInput(SystemContext* context, InputEvent event) {
    if (setupPage) {
        switch (event) {
            case InputEvent::EnterPressed: stateMachine->changeState(SetupStates::TEMPERATURE_RANGE_EDIT_MAX, context); break;
...
void TR_E_MAX::handleInput(SystemContext* context, InputEvent event) {
    if (setupPage) {
        switch (event) {
            case InputEvent::EnterPressed: stateMachine->changeState(SetupStates::TEMPERATURE_RANGE_SELECT, context); break;
...
void D_E::handleInput(SystemContext* context, InputEvent event) {
    if (setupPage) {
        switch (event) {
            case InputEvent::EnterPressed: stateMachine->changeState(SetupStates::DURATION_SELECT, context); break;
